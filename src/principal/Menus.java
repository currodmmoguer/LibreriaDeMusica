...
public class Menus {
	...
	protected static int menuArtistas() {
		...
		try {
			...
			System.out.println("5. Consultar las canciones de un artista");
	...
	protected static int menuCancion() {
		...
		try {
			...
			System.out.println("4. Consultar todas las canciones");
	...
	protected static int menuAlbum() {
		...
		try {
			...
			System.out.println("4. Consultar todos los álbunes");
			System.out.println("5. Volver");
	...
	protected static int menuPlaylist() {
		...
		try {
			...
			System.out.println("9. Consultar cual es el género más escuchado de una playlist");
